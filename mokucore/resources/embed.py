...
def help_embed():
    text = "" \
           ...
           "!tk auto-delete seconds\t\t\t-    change the duration of the bot waiting until he deletes the message in " \
           "this channel (-1 = deactivate)\n" \
           "!tk feedback message\t\t\t- send message including sender name to the devs \n\n " \
